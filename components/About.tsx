      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="w-48 h-48 rounded-full bg-stone/30 dark:bg-parchment/10 border-4 border-gold flex items-center justify-center mb-8 overflow-hidden relative shadow-xl">
            <span className="font-cinzel text-ink dark:text-parchment opacity-50">Gambar</span>
          </div>
          ...
          <div className="flex gap-4 w-full justify-center">
            <div className="bg-parchment-dark dark:bg-ember border border-gold/40 rounded-lg p-4 text-center w-28">
              ...
              <div className="font-garamond text-sm text-ink dark:text-parchment font-bold">Proyek</div>
            </div>
            <div className="bg-parchment-dark dark:bg-ember border border-gold/40 rounded-lg p-4 text-center w-28">
              <div className="font-cinzel text-crimson text-2xl font-bold">2</div>
              <div className="font-garamond text-sm text-ink dark:text-parchment font-bold">Tahun</div>
            </div>
            <div className="bg-parchment-dark dark:bg-ember border border-gold/40 rounded-lg p-4 text-center w-28">
              <div className="font-cinzel text-crimson text-2xl font-bold">8</div>
              <div className="font-garamond text-sm text-ink dark:text-parchment font-bold">Klien</div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <h2 className="font-cinzel-deco text-4xl text-ink dark:text-parchment mb-6">Sang Penjelajah Digital</h2>
          
          <div className="font-garamond text-lg leading-relaxed text-stone dark:text-parchment/60 space-y-6">
